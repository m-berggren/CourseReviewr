  ...
  <div>
    <b-card class="review-card">
      ...
      <b-row class="mt-2">
        ...
        <b-col md="4">
            <b-button v-if="userReview === userToken" v-b-modal.modal-edit-review class="ms-4 mt-3 edit-button">Edit review</b-button>
        ...
        <!-- Modal component -->
        <b-modal id="modal-edit-review" title="Edit Review">
