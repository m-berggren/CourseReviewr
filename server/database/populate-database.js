...
// JSON files
const topics = './database/data/topics.json';
const courses = './database/data/courses.json';
const users = './database/data/users.json';
const courseLists = './database/data/course-lists.json';
const reviews = './database/data/reviews.json';
